...
public class DataLoader implements ApplicationRunner {
    ...
    public void run (ApplicationArguments args) throws Exception {
        ...
        BufferedReader csvReader = new BufferedReader(new FileReader("src/main/java/com/gmorgan/framedesigner/data/hollow_sections.csv"));
        String row;
        ...
        BufferedReader csvReaderBeam = new BufferedReader(new FileReader("src/main/java/com/gmorgan/framedesigner/data/beams.csv"));
        String rowBeam;
