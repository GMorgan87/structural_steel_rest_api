...
public interface SectionRepository extends JpaRepository<Section, Long> {
    ...
    List<Section> findAllByIxxGreaterThanAndZxxGreaterThanAndIyyGreaterThanAndZyyGreaterThanAndYGreaterThanAndDescContainsIgnoreCase(double ixx, double zxx, double iyy, double zyy, double y, String desc);
